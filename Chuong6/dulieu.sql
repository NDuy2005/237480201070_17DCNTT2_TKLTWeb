...
-- Tạo bảng NHASANXUAT trước để làm tham chiếu
...
-- ==========================================
-- 3. CHÈN DỮ LIỆU (DATA INSERTION)
-- ==========================================

-- Chèn dữ liệu bảng NHASANXUAT (Hình 2)
...
-- Chèn dữ liệu bảng HANGHOA (Hình 1)
...
-- Chèn dữ liệu bảng KHACHHANG (Hình 1)
...
-- Chèn dữ liệu bảng HOADON (Hình 2)
-- Lưu ý: Thành tiền được tính thủ công dựa trên giá của HANGHOA * Soluong
